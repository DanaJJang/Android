        ...
        if (requestCode == RC_SIGN_IN) {
            ...
            if (task.isSuccessful) {
                try {
                    ...
                    Log.w("SignInActicity", "Google sign in failed", e)
                    // ...
                }
            } else {
        ...
        mAuth.signInWithCredential(credential)
            .addOnCompleteListener(this) { task ->
                if (task.isSuccessful) {
                    ...
                    Log.d("SignInActicity", "signInWithCredential:success")
                    ...
                    Log.w("SignInActicity", "signInWithCredential:failure", task.exception)
